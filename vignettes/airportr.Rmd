...
Airport data is from the [OpenFlights Airport Database](https://openflights.org/data#airport) made available under the [Open Database License](https://opendatacommons.org/licenses/odbl/1-0/). 
